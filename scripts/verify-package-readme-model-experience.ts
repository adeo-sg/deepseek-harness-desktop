...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-window-controls': { kind: 'none', reason: 'Browser-side window chrome; the cluster issues no RPC, adds no session event, and registers nothing model-facing.' },
